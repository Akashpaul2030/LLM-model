...
set_target_properties(Parquet::parquet_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "D:/Project/langchain/ATS/venv/Library/parquet.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/parquet.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Parquet::parquet_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_Parquet::parquet_shared "D:/Project/langchain/ATS/venv/Library/parquet.lib" "${_IMPORT_PREFIX}/bin/parquet.dll" )
